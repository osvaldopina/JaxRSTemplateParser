...
public class JaxRsResourceTreeData {
    ...
    private Node<JaxRsResourceTreeData> node;
    ...
    public JaxRsResourceTreeData(TemplatePart templatePart) {
    ...
    private String getFullLiteralPath() {
        Node<JaxRsResourceTreeData> node = getNode();
    ...
    public Node<JaxRsResourceTreeData> getNode() {
        return node;
    }
